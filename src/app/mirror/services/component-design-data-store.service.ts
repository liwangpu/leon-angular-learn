...
@Injectable()
export class ComponentDesignDataStoreService {

    private uri: string = `${environment.APIServer}/mirror/data/system_component`;
    public constructor(
    ...
    public getAll(): Observable<IQueryResult> {
        return this.storeSrv.query('system_component', {
            pagination: `limit=9999999`
        });
    }

    public delete(id: string): Observable<any> {
        return this.storeSrv.delete('system_component', id);
    }
}
